...
public class FoodModel {
    ...
    public FoodModel(String key, Double ratingValue, Long ratingCount, String name, String image, String id, String description, Long price, List<AddonModel> addon, List<SizeModel> size) {
        this.key = key;
