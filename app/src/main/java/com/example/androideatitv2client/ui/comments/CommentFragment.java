package com.example.androideatitv2client.ui.comments;
...
import CallBack.ICommentCallBackListener;
...
public class CommentFragment extends BottomSheetDialogFragment implements ICommentCallBackListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        commentViewModel.getMutableLiveDataFoodList().observe(getViewLifecycleOwner(), commentViewModels -> {
            MyCommentAdapter adapter=new MyCommentAdapter(getContext(),commentViewModels);
        ...
        FirebaseDatabase.getInstance().getReference(Common.COMMENT_REF)
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for (DataSnapshot commentSanpshot:dataSnapshot.getChildren())
                        {
                            CommentModel commentModel=commentSanpshot.getValue(CommentModel.class);
