...
import Remote.ICloudFunctions;
import Remote.RetrofitCloudClient;
import dmax.dialog.SpotsDialog;
import io.reactivex.disposables.CompositeDisposable;

public class MainActivity extends AppCompatActivity {

    private static int APP_REQUEST_CODE=7171; //ANY CODE
        ...
        userRef.child(user.getUid())
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        {
                            Toast.makeText(MainActivity.this, "You Already Login", Toast.LENGTH_SHORT).show();
            ...
            userRef.child(user.getUid()).setValue(userModel)
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            {
                                dialog.dismiss();
                                Toast.makeText(MainActivity.this, "Congratulation ! Register Sucess", Toast.LENGTH_SHORT).show();
                                goToHomeActivity(userModel);
                            }
                        }
                    });
    ...
    private void goToHomeActivity(UserModel userModel) {
        Common.currentUser = userModel; //u need always assign value
